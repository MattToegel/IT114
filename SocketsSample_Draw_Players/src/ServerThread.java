...
public class ServerThread extends Thread{
	...
	private void processPayload(Payload payload) {
		...
		case CONNECT:
			//TODO would normally set clientname here but this example doesn't
			//have a way to set from client so we'll use the default
		...
		case DISCONNECT:
			...
			server.removePlayer(this.getClientId());
			break;
		case MESSAGE:
		...
		case DIRECTION:
			...
			server.updateDirection(payload);
			break;
		default:
