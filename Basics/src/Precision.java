public class Precision {
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("A: " + a); System.out.println("B: " + b); // let's see
		 * the same for doubles double x = 1d; double y = 0d; for (int i = 0; i < 10;
		 * i++) { y += 0.1d; } System.out.println("X equals Y?" + (x == y));
