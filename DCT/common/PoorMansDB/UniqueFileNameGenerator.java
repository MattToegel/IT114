...
public class UniqueFileNameGenerator {
    ...
    /**
     * Constructs a UniqueFileNameGenerator with the given directory path and
     * subdirectory.
     *
     * @param directoryPath the path of the directory where the files will be
     *                      generated
     * @param subDirectory  the subdirectory within the directoryPath where the
     ...
     * @return a CompletableFuture that will eventually contain the generated unique
     *         file name
     * @throws RuntimeException if the counter exceeds 3999 during file name
     *                          generation
     */
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            do {
                fileName = String.format("%s%s%s%s%s",
                        ...
                        baseName,
                        (counter == 0 ? "" : " " + (getSuffix == null ? counter : getSuffix.apply(counter))), // If a
                                                                                                              // name
                                                                                                              // exists,
                                                                                                              // append
                                                                                                              // a
